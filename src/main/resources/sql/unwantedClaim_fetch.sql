...
union all
     select   mc.ins_id,mc.prvdr_id,m.mbr_lastname,m.Mbr_FirstName,m.Mbr_DOB,m.Mbr_GenderID,  mc.report_month, mcd.activity_month,   mc.claim_type,  sum(round( mcd.membership_claims  ,2)) claims
