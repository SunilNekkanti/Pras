...
frequency_type_code,bill_type,ndc,mony,drug_label_name,drug_version,dischargestatus,
...
SELECT DISTINCT
CLAIMNUMBER,mi.mbr_id,mp.prvdr_id,mi.ins_id, CLAIMTYPE,csv2AmgClaim.FACILITY_TYPE_CODE,null,
null,csv2AmgClaim.BILLTYPE,null,null,csv2AmgClaim.DRG,csv2AmgClaim.DRG_VERSION,
csv2AmgClaim.DISCHARGESTATUS,null,
