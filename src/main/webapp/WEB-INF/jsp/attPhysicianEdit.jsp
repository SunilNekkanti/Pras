...
<div class="panel-group">
	<div class="panel panel-success">
		<div class="panel-heading">
			AttPhysician Profile <span class="clrRed">${Message}</span> <a
				class="btn btn-danger pull-right btn-xs white-text"
				href="${context}/attPhysicianList"> <span
				class="glyphicon glyphicon-plus-sign "></span>AttPhysician List
			</a>
		</div>
		<div class="panel-body">
			<springForm:form method="POST" commandName="attPhysician"
				action="${context}/attPhysician/${id}/save.do"
