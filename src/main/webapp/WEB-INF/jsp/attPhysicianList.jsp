...
<script>
    ...
    $(document).ready(function() {
    	var datatable2RestAttPhysician = function(sSource, aoData, fnCallback) {
	 ...
	 $.ajax( {
    	...
    	var attPhysicianTable =	$('#attPhysicianTable').dataTable({
    	     ...
    	     "aoColumns": [
                           ...
                           { "mDataProp": "name","bSearchable" : true, "bSortable" : true,"sWidth" : "70%"},
              ...
              "aoColumnDefs": [ 
                       		    ...
                       		    { "sName": "name", "aTargets": [ 1 ],
                         		   "render": function ( data, type, full, meta ) {
                                          return '<a href="${context}/attPhysician/'+full.id+'">'+data+'</a>';
                                 } },
    	     ...
    	     "bProcessing": true,
    	     "bServerSide" : true,
    	     "fnServerData" : datatable2RestAttPhysician
    	});
...
<div class="panel-group">
	<div class="panel panel-success">
		<div class="panel-heading">
			AttPhysician List <span class="clrRed">${Message}</span> <a
				class="btn btn-danger pull-right btn-xs white-text"
				href="${context}/attPhysician/new"> <span
				class="glyphicon glyphicon-plus-sign "></span>New AttPhysician
			</a>
		</div>
		<div class="panel-body">
			<table id="attPhysicianTable"
