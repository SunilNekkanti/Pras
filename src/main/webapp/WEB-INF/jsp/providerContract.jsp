...
<div class="panel-group">
	<div class="panel panel-success">
		...
		<div class="panel-body" id="tablediv">
			<springForm:form method="POST" commandName="providerContract"
				action="save.do">
				<div class="form-group col-sm-12">
					<label class="control-label col-sm-2" for="name">Contract
						NBR:</label>
					<div class="col-sm-6">
				...
				<div class="form-group col-sm-12">
					...
					<div class="col-sm-6">
						<springForm:select path="activeInd" class="form-control"
							id="activeInd">
