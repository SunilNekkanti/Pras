...
<div class="panel-group">
	<div class="panel panel-success">
		<div class="panel-heading">Hedis Measure Group Details
			<span class="clrRed">${Message}</span>
			<a class="btn btn-danger pull-right btn-xs white-text"href="${context}/hedisMeasureGroupList">
          		<span class="glyphicon glyphicon-plus-sign "></span>Hedis Measure Group List
          	</a>
		</div>
					
	
		<div class="panel-body" id="tablediv">
			<springForm:form method="POST" commandName="hedisMeasureGroup" action="save.do">
				<div class="form-group required col-sm-12">
						    <label class="control-label  col-sm-2" for="code">Code</label>
						    <div class="col-sm-6">
						    	<springForm:hidden path="id" />
						      	<springForm:input path="code" class="form-control" id="code" placeholder="User Id" />
				...
				<div class="col-sm-offset-2 col-sm-6">
					<c:choose>
						 <c:when test="${hedisMeasureGroup.id != null && hedisMeasureGroup.activeInd == 89}"> 
						 ...
						 <c:when test="${hedisMeasureGroup.id == null}"> 
