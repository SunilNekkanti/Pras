  ...
  $(document).ready(function() {
        	...
        	$('#hedisMeasureTable').dataTable({
        	     ...
        	     "aoColumns": [
                               ...
                               { "mDataProp": "template","bSearchable" : true, "bSortable": true,"sWidth" : "30%"  }
                           ],
                  "aoColumnDefs": [ 
                           		    { "sName": "id", "aTargets": [ 0 ] },
                           		    { "sName": "code", "aTargets": [ 1 ],
                           		      "render": function ( data, type, full, meta ) {
                                            return '<a href="${context}/emailTemplate/'+full.id+'">'+data+'</a>';
                           		      }},
	...
	<div class="panel panel-success">
		<div class="panel-heading">
			Email Template List <span class="clrRed">${Message}</span> <a
				...
				href="${context}/emailTemplate/new"> <span
				class="glyphicon glyphicon-plus-sign "></span>New Email Template
			</a>
		</div>
