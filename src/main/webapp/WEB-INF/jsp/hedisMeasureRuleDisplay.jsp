...
<c:choose>
	<c:when
		test="${hedisMeasureRule.id != null && hedisMeasureRule.activeInd != 89}">
		<script>
	...
	<div class="panel-body" id="tablediv">
		<springForm:form method="POST" commandName="hedisMeasureRule"
			...
			<div class="form-group required">
				...
				<div class="col-sm-6">
					<springForm:select multiple="true" path="cptCodes"
						class="form-control" items="${cptMeasureList}" itemLabel="code"
						itemValue="id" />
			...
			<div class="form-group required">
				...
				<div class="col-sm-6">
					<springForm:select multiple="true" path="icdCodes"
						class="form-control" items="${icdMeasureList}" itemLabel="code"
						itemValue="id" />
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<fmt:formatDate value="${hedisMeasure.ageEffectiveFrom}"
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="ageEffectiveTo ">Age
					Effective To</label>
				<div class="col-sm-6">
					<fmt:formatDate value="${hedisMeasure.ageEffectiveTo}"
						var="dateString" pattern="MM/dd/yyyy" />
