...
<body>
	<div class="panel with-nav-tabs panel-primary">
		...
		<div class="panel-body" id="tablediv">
			...
			<springForm:form method="POST" commandName="contract"
				action="save.do" class="form-horizontal" role="form">
				<div class="form-group">
					<label class="control-label col-sm-2" for="contractNBR">Contract
						NBR:</label>
					<div class="col-sm-6">
						<springForm:hidden path="id" />
						<springForm:input path="contractNBR" class="form-control"
							id="contractNBR" placeholder="Contact NBR" />
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<springForm:input path="pmpm" class="form-control"
							id="mobilePhone" placeholder="PMPM" />
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="startDate">Start
						Date:</label>
					<div class="col-sm-6">
						<springForm:input path="startDate" class="form-control"
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="startDate">End
						Date:</label>
					<div class="col-sm-6">
						<springForm:input path="endDate" class="form-control" id="endDate"
				...
				<div class="col-sm-offset-6 col-sm-4">
					<a href="${context}/provider/${id}">Click Here</a> Edit Provider
					profile
				</div>
			</springForm:form>
		</div>
