...
<div class="panel-group">
	<div class="panel panel-success">
		<div class="panel-heading">
			Hedis Measure Group Details <span class="clrRed">${Message}</span> <a
				class="btn btn-danger pull-right btn-xs white-text"
				href="${context}/hedisMeasureGroupList"> <span
				class="glyphicon glyphicon-plus-sign "></span>Hedis Measure Group
				List
			</a>
		</div>
		<div class="panel-body" id="tablediv">
			<springForm:form method="POST" commandName="hedisMeasureGroup"
				action="${context}/hedisMeasureGroup/${id}/save.do">
				...
				<div class="col-sm-offset-2 col-sm-6">
					<c:choose>
						<c:when
							test="${hedisMeasureGroup.id != null && hedisMeasureGroup.activeInd == 89}">
