...
<script>
    ...
    $(document).ready(function() {
    	var datatable2RestBillType = function(sSource, aoData, fnCallback) {
	 ...
	 $.ajax( {
    	...
    	var billTypeTable =	$('#billTypeTable').dataTable({
              ...
              "aoColumnDefs": [ 
                       		    ...
                       		    { "sName": "description", "aTargets": [ 1 ],
                         		   "render": function ( data, type, full, meta ) {
                                          return '<a href="${context}/billType/'+full.id+'">'+data+'</a>';
                                 } },
    	     ...
    	     "bProcessing": true,
    	     "bServerSide" : true,
    	     "fnServerData" : datatable2RestBillType
    	});
...
<div class="panel-group">
	<div class="panel panel-success">
		<div class="panel-heading">
			BillType List <span class="clrRed">${Message}</span> <a
				class="btn btn-danger pull-right btn-xs white-text"
				href="${context}/billType/new"> <span
				class="glyphicon glyphicon-plus-sign "></span>New BillType
			</a>
		</div>
