								...
								.click(
										function(e) {
											...
											for ( var e in checkedCPTItemsMap) {
												...
												var optionExists = ($('#cptCodes option[value='
														+ e + ']').length > 0);
												if (!optionExists) {
													cptCodes
															.append('<option value ="'+e+'" selected ="selected">'
																	+ value
																	+ '</option>');
												}
											}
						...
						$('#cptListTable tbody')
								.on(
										...
										function(e) {
											...
											if ($(this).is(':checked')) {
												checkedCPTItemsMap[$(this)
														.attr('id')] = $(this)
														.attr('value');

											} else {
												delete checkedCPTItemsMap[$(
														this).attr('id')];
											}
										});
								...
								.click(
										function(e) {
											...
											for ( var e in checkedICDItemsMap) {
												...
												var optionExists = ($('#icdCodes option[value='
														+ e + ']').length > 0);
												if (!optionExists) {
													cptCodes
															.append('<option value ="'+e+'" selected ="selected">'
						...
						$('#icdListTable tbody')
								.on(
										...
										function(e) {
											...
											if ($(this).is(':checked')) {
												checkedICDItemsMap[$(this)
														.attr('id')] = $(this)
														.attr('value');

											} else {
												delete checkedICDItemsMap[$(
														this).attr('id')];
											}
										});
						var datatable2Rest = function(sSource, aoData,
								fnCallback) {
											...
											"aoColumns" : [
													{
														...
														"render" : function(
																data, type,
																full, meta) {
															return '<input type="checkbox" name="cptchkbox"   id="'
																	+ data
																	+ '" value="'
																	+ full.code
																	+ ' ('
											...
											"aoColumns" : [
													{
														...
														"render" : function(
																data, type,
																full, meta) {
															return '<input type="checkbox" name="chkbox"  id="'
																	+ data
																	+ '" value="'
																	+ full.code
																	+ ' ('
...
<body>
	...
	<div class="panel with-nav-tabs panel-primary">
		<div class="panel-heading">
			<ul class="nav nav-tabs">
				<li class="active"><a href="#" data-toggle="tab">Hedis
						Measure Rule</a></li>
			</ul>
		</div>
		<div class="panel-body" id="tablediv">
			<springForm:form method="POST" commandName="hedisMeasureRule"
				action="${context}/hedisMeasureRule/${id}/save.do"
				class="form-horizontal" role="form">
				<springForm:hidden path="id" />
				<div class="form-group required">
					<label class="control-label col-sm-2" for="hedis">Hedis
						Code</label>
					<div class="col-sm-6">
				...
				<div class="form-group required">
					...
					<div class="col-sm-1">
						<a class="btn" data-popup-open="popup-1" href="#"> <span
							class="glyphicon glyphicon-plus"></span> ADD
						</a> <a id='removeCPT'> <span class="glyphicon glyphicon-minus"></span>
							Remove
						</a>
					</div>
				</div>
				...
				<div class="form-group required">
					...
					<div class="col-sm-1">
						<a class="btn" data-popup-open="popup-2" href="#"> <span
							class="glyphicon glyphicon-plus"></span>ADD
						</a> <a id="removeICD"> <span class="glyphicon glyphicon-minus"></span>
							Remove
						</a>
					</div>
				</div>
				...
				<div class="form-group required">
					<label class="control-label col-sm-2" for="year">Effective
						Year (YYYY)</label>
					<div class="col-sm-6">
						<springForm:input path="effectiveYear" class="form-control"
							id="effectiveYear" placeholder="Effective Year" />
	...
	<div class="popup" data-popup="popup-1">
		<div class="popup-inner">
			...
			<p>
				<a data-popup-close="popup-1" href="#" id="addCPT">Add</a>
			</p>
	...
	<div class="popup" data-popup="popup-2">
		<div class="popup-inner">
			...
			<p>
				<a data-popup-close="popup-2" href="#" id="addICD">Add</a>
			</p>
