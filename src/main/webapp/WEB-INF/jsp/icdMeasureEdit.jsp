...
<div class="panel panel-success">
	<div class="panel-heading">
		ICD Measure <span class="clrRed">${Message}</span> <a
			class="btn btn-danger pull-right btn-xs white-text"
			href="${context}/icd/icdMeasureList"> <span
			class="glyphicon glyphicon-plus-sign "></span>ICD Measure List
		</a>
	</div>
	<div class="panel-body" id="tablediv">
		<springForm:form method="POST" commandName="icdMeasure"
			action="${context}/icd/${id}/save.do" class="form-horizontal"
			role="form">
			<div class="form-group required">
				<label class="control-label col-sm-2" for="code">Code</label>
				<div class="col-sm-6">
					<springForm:hidden path="id" />
					<springForm:input path="code" class="form-control" maxlength="10"
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<springForm:input path="hcc" class="form-control" id="hcc"
						maxlength="10" placeholder="hcc" />
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<springForm:input path="rxhcc" class="form-control" id="rxhcc"
						maxlenth="10" placeholder="rxhcc" />
			...
			<div class="col-sm-offset-6 col-sm-4">
				<c:choose>
					<c:when
						test="${icdMeasure.id != null && icdMeasure.activeInd == 89}">
