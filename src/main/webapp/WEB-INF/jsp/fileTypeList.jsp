...
<div class="panel-group">
	<div class="panel panel-success">
		...
		<span class="clrRed">${Message}</span>
			<a class="btn btn-danger pull-right btn-xs white-text"href="${context}/fileType/new">
          		<span class="glyphicon glyphicon-plus-sign "></span>New File Type
          	</a>
		</div>
		<div class="panel-body" >
			<table id="fileTypeTable" class="table table-striped table-hover table-responsive">
				<thead>
					<tr>
