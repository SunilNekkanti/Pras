...
<div class="panel-group">
	<div class="panel panel-success">
		...
		<div class="panel-body" id="tablediv">
			<springForm:form method="POST" commandName="fileType" action="save.do">
				<div class="form-group required col-sm-12">
						    <label class="control-label  col-sm-2" for="description">Description</label>
						    <div class="col-sm-6">
						    	<springForm:hidden path="code" />
						      	<springForm:input path="description" class="form-control" id="code" placeholder="Description" />
				...
				<div class="col-sm-offset-2 col-sm-6">
					<c:choose>
						 <c:when test="${planType.code != null && planType.activeInd == 89}"> 
