...
<div class="panel-group">
	<div class="panel panel-success">
		...
		<div class="panel-body" id="tablediv">
			<springForm:form method="POST" commandName="leadMembershipHedisMeasure"
				action="save.do" class="form-horizontal" role="form">
				<div class="col-sm-12">
					<div class="col-sm-4">
						<div class="form-group required">
							<label class="control-label col-sm-5" for=hedisMeasureCode>Hedis Measure Code</label>
							<div class="col-sm-7">
								<springForm:select path="hedisMeasureRule" class="form-control" id="hedisMeasureRule">
