...
<script>
    ...
    $(document).ready(function() {
    	var datatable2RestHospital = function(sSource, aoData, fnCallback) {
	 ...
	 $.ajax( {
    	...
    	var hospitalTable =	$('#hospitalTable').dataTable({
              ...
              "aoColumnDefs": [ 
                       		    ...
                       		    { "sName": "name", "aTargets": [ 1 ],
                         		   "render": function ( data, type, full, meta ) {
                                          return '<a href="${context}/hospital/'+full.id+'">'+data+'</a>';
                                 } },
    	     ...
    	     "bProcessing": true,
    	     "bServerSide" : true,
    	     "fnServerData" : datatable2RestHospital
    	});
...
<div class="panel-group">
	<div class="panel panel-success">
		<div class="panel-heading">
			Hospital List <span class="clrRed">${Message}</span> <a
				class="btn btn-danger pull-right btn-xs white-text"
				href="${context}/hospital/new"> <span
				class="glyphicon glyphicon-plus-sign "></span>New Hospital
			</a>
		</div>
