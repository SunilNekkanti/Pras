		...
		<div class="panel-body" id="tablediv">
			<div class="col-sm-12" style="min-height: 300px;">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<springForm:input path="firstName" class="form-control"
								...
								<div class="form-group">
									<label class="control-label col-sm-4" for="lastName">Last
										Name</label>
									<div class="col-sm-8">
										<springForm:input path="lastName" class="form-control"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<springForm:errors path="genderId.description"
											cssClass="error text-danger" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<springForm:select path="ethinicCode.id" class="form-control"
											id="ethinicCode">
											<springForm:option value="${null}" label="Select Ethinicity" />
											<springForm:options items="${ethinicityList}" itemValue="id"
												itemLabel="description" />
										</springForm:select>
										<springForm:errors path="ethinicCode"
											cssClass="error text-danger" />
									</div>
								</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<springForm:errors path="status.description"
											cssClass="error text-danger" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<springForm:errors path="countyCode.description"
											cssClass="error text-danger" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-4" for="medicaidNo">Medicaid
										No</label>
									<div class="col-sm-8">
										<springForm:input path="medicaidNo" class="form-control"
											id="medicaidNo" placeholder="Medicaid No" />
										<springForm:errors path="medicaidNo"
											cssClass="error text-danger" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-4" for="medicaidNo">Medicare
										No</label>
									<div class="col-sm-8">
										<springForm:input path="medicareNo" class="form-control"
											id="medicareNo" placeholder="Medicare No" />
				...
				<div class="col-sm-offset-2 col-sm-10">
					<a href="${context}/membership/${id}">Click Here</a> Edit
					membership profile
				</div>
			</div>
		</div>
