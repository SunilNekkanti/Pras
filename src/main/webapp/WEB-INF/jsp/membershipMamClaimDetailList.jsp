			...
			.ready(
					function() {
						...
						var callClaimGenerate = function() {
							...
							columns.push({
								"mDataProp" : "mbrClaim.mbr.firstName",
								"bSearchable" : true,
								"bSortable" : true,
								"sClass" : "center",
								"sWidth" : "10%",
								"render" : function(data, type, full,
									...
									return '<a href="${context}/membership/'+full.mbrClaim.mbr.id+'/complete">'
											+ full.mbrClaim.mbr.lastName
											+ ', '
											+ full.mbrClaim.mbr.firstName + '</a>';
								}
							});
							columns.push({	"mDataProp" : "mbrClaim.claimNumber", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%" });							
							columns.push({  "mDataProp" : "mbrClaim.prvdr.name",	"bSearchable" : true,	"bSortable" : true,	"sClass" : "center",	"sWidth" : "10%", "sDefaultContent": ""  });
							columns.push({	"mDataProp" : "mbrClaim.claimType", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%" });
							columns.push({	"mDataProp" : "mbrClaim.facilityType.description", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
							columns.push({	"mDataProp" : "mbrClaim.diagnosis",  "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%" });
							columns.push({	"mDataProp" : "mbrClaim.tin", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
							columns.push({	"mDataProp" : "mbrClaim.billType.description", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
							columns.push({	"mDataProp" : "mbrClaim.billTypec", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
							columns.push({	"mDataProp" : "mbrClaim.frequencyType.description", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
							columns.push({	"mDataProp" : "mbrClaim.dischargeStatus",  "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
							columns.push({	"mDataProp" : "mbrClaim.MemEnrollId",  "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
							columns.push({	"mDataProp" : "claimLineseqNbr", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
							columns.push({	"mDataProp" : "clmLineAdjSeqNbr", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
							columns.push({	"mDataProp" : "activityDate", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%" ,
				                	"render": function (data) {
   		   		        		var date = new Date(data);
   		   	        			var month = date.getMonth() + 1;
   		   	       				 return (month > 9 ? month : "0" + month) + "/" + date.getDate() + "/" + date.getFullYear();
   		   		   	 		}});
   		   		   			columns.push({"mDataProp" : "activityMonth", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%" });
   		   		   			columns.push({"mDataProp" : "claimStartDate", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%",
									"render": function (data) {
       		   		        		var date = new Date(data);
       		   	        			var month = date.getMonth() + 1;
       		   	       				 return (month > 9 ? month : "0" + month) + "/" + date.getDate() + "/" + date.getFullYear();
       		   		   	    }});
       		   		  		columns.push({"mDataProp" : "claimEndDate", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%",
       		   		   	    	"render": function (data) {
   		   		        		var date = new Date(data);
   		   	        			var month = date.getMonth() + 1;
   		   	       				 return (month > 9 ? month : "0" + month) + "/" + date.getDate() + "/" + date.getFullYear();
   		   		   	 		}});
   		   		   			columns.push({"mDataProp" : "paidDate", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "",
									"render": function (data) {
       		   		        		var date = new Date(data);
       		   	        			var month = date.getMonth() + 1;
       		   	       				 return (month > 9 ? month : "0" + month) + "/" + date.getDate() + "/" + date.getFullYear();
       		   		   	    }});
       		   		  		columns.push({"mDataProp" : "revenueCode", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%"});
       		   		  		columns.push({"mDataProp" : "cpt.code", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "cptCodeModifier1", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "cptCodeModifier2", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "claimStatus", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "roomType.name", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
       		   		  		columns.push({"mDataProp" : "riskReconCosDes", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
       		   		  		columns.push({"mDataProp" : "amountPaid", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "allowAmt", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "coInsurance", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "coPay", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "deductible", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "cobPaidAmount", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "processingStatus", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "pharmacyName", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "quantity", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "npos", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "riskId", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "runnDate", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "ndc", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "mony", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
       		   		  		columns.push({"mDataProp" : "drugLabelName", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
       		   		  		columns.push({"mDataProp" : "drugVersion", "bSearchable" : true, "bSortable" : true, "sClass" : "center", "sWidth" : "10%", "sDefaultContent": "" });
       		   		  		columns.push({"mDataProp" : "pharmacy", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "membershipClaims", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "psychare", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "simpleCounty", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "triangles", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "cover", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
       		   		  		columns.push({"mDataProp" : "mbrClaim.mbr.mbrActivityMonthList[0].activityMonth", "bSearchable" : true,	"bSortable" : true,"sClass" : "center", "sWidth" : "10%", "sDefaultContent" : ""});
						...
						function callDatableWithChangedDropDown() {
							var processClaimValue = $("#claim option:selected").val();
							var insSelectValue = $("#insu option:selected")
									.val();
							...
							var yearPickerValue = $("#yearPicker").val();
							 ...
							 var monthArray = new Array; var yearArray = new Array;
							 $("#yearPicker option:selected").each  ( function() {
								yearValue = $(this).val();
								yearArray.push (yearValue);
					    		   $("#monthPicker option:selected").each  ( function() {
					    			   monthArray.push (yearValue+""+$(this).val());
					    		    });
							 });
							...
							GetMembershipByInsPrvdr(insSelectValue,
									prvdrSelectValue, monthArray,
									yearArray, processClaimValue, columns);
						}
						...
						GetMembershipByInsPrvdr = function(insId, prvdrId,
								monthPicker, yearPicker, processClaim, aoColumns) {
				...
				<div class="col-sm-12 hosFilter">
					...
					<div class="col-sm-12">
						<div class="col-sm-4">
							...
							<div class="col-sm-7">
									<select name="yearPicker" id="yearPicker" class="btn btn-default" multiple></select>
							</div>
						</div>
						...
						<div class="col-sm-3">
							...
							<div class="col-sm-7">
									<select name="monthPicker" id="monthPicker" class="btn btn-default" multiple></select>
							</div>
						</div>
						
						<div class="col-sm-5">
							<div class="col-sm-8">
								<label class="control-label col-sm-4">Claim</label>
								<select name="claim" id="claim" class="btn btn-default">
							...
							<div class="col-sm-4">
								<button type="button" id="claimGenerate" class="btn btn-success btn-sm btn-xs">Generate</button>
							</div>
				...
				<table id="membershipClaimTable"
					...
					<thead>
						<tr>
							...
							<th scope="col" role="row">Cover1</th>
