...
<title>Facility Type List</title>
...
<script>
    ...
    $(document).ready(function() {
    	var datatable2RestFacilityType = function(sSource, aoData, fnCallback) {
	 ...
	 $.ajax( {
    	...
    	var facilityTypeTable =	$('#facilityTypeTable').dataTable({
              ...
              "aoColumnDefs": [ 
                       		    ...
                       		    { "sName": "description", "aTargets": [ 1 ],
                         		   "render": function ( data, type, full, meta ) {
                                          return '<a href="${context}/facilityType/'+full.id+'">'+data+'</a>';
                                 } },
    	     ...
    	     "bProcessing": true,
    	     "bServerSide" : true,
    	     "fnServerData" : datatable2RestFacilityType
    	});
...
<div class="panel-group">
	<div class="panel panel-success">
		<div class="panel-heading">
			Facility Type List <span class="clrRed">${Message}</span> <a
				class="btn btn-danger pull-right btn-xs white-text"
				href="${context}/facilityType/new"> <span
				class="glyphicon glyphicon-plus-sign "></span>New Facility Type
			</a>
		</div>
		<div class="panel-body">
			<table id="facilityTypeTable"
