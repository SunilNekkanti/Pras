	...
	<div class="panel panel-success">
		...
		<div class="panel-body" id="tablediv">
			...
			<div class="col-sm-12">	
				...
				<div class="col-sm-4">	
					<div class="form-group">
					 	<label class="control-label col-sm-5" for="dob">New Benifits</label>
						<div class="col-sm-7">
				...
				<div class="col-sm-4">	
					<div class="form-group required">
					 	<label class="control-label required col-sm-5" for="activityDate">Activity Date</label>
						<div class="col-sm-7">
							<fmt:formatDate value="${membershipInsurance.activityDate}" var="dateString" pattern="MM/dd/yyyy" />
							<springForm:input path="activityDate" value="${dateString}" class="form-control datepicker" onfocus="datePicker()"  id="activityDate" placeholder="activityDate" />
			...
			<div class="col-sm-12">	
				...
				<div class="col-sm-4">
					<div class="form-group">
					 	<label class="control-label col-sm-5" for="productLabel">Product Label</label>
						<div class="col-sm-7">
				...
				<div class="col-sm-4">				
					<div class="form-group">
					 	<label class="control-label col-sm-5" for="planId">Plan Id</label>
						<div class="col-sm-7">
			...
			<div class="col-sm-12">	
				<div class="col-sm-4">
					<div class="form-group">
					 	<label class="control-label col-sm-5" for="dob">Src Sys Mbr Nbr</label>
						<div class="col-sm-7">
