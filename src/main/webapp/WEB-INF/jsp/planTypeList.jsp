...
<script>
        $(document).ready(function() {
        	...
        	var datatable2RestPlanType = function(sSource, aoData, fnCallback) {
        	...
        	$('#planTypeTable').dataTable({
        	     ...
        	     "bProcessing": true,
        	     "bServerSide" : true,
        	     "fnServerData" : datatable2RestPlanType
        	});
...
<div class="panel-group">
	<div class="panel panel-success">
		<div class="panel-heading"> Plan Type List
		<span class="clrRed">${Message}</span>
			<a class="btn btn-danger pull-right btn-xs white-text"href="${context}/planType/new">
          		<span class="glyphicon glyphicon-plus-sign "></span>New Plan Type
          	</a>
		</div>
		<div class="panel-body" >
			<table id="planTypeTable" class="table table-striped table-hover table-responsive">
				<thead>
					<tr>
