		...
		<div class="panel-body" id="tablediv">
			<springForm:form method="POST" commandName="contact" action="save.do" class="form-horizontal" role="form">
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
				 	<label class="control-label  required col-sm-2" for="faxNumber">Address 1:</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
				 	<label class="control-label  required col-sm-2" for="city">City:</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="control-label required col-sm-2" for="state">State:</label>
					<div class="col-sm-6">
					...
					<div class="form-group">
					<label class="control-label  required col-sm-2" for="zip">Zip:</label>
					<div class="col-sm-6">
