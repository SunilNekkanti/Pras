 ...
 */
@Repository
public class LeadMembershipClaimDetailsDaoImpl extends HibernateBaseDao<LeadMembershipClaimDetails, Integer>
		implements LeadMembershipClaimDetailsDao {
	...
	public LeadMembershipClaimDetails deleteById(final Integer id) {
		LeadMembershipClaimDetails entity = super.get(id);
		if (entity != null) {
	 ...
	 */
	@Override
	protected Class<LeadMembershipClaimDetails> getEntityClass() {
		return LeadMembershipClaimDetails.class;
	}
