 ...
 */
@Repository
public class LeadMembershipHospitalizationDaoImpl extends HibernateBaseDao<LeadMembershipHospitalization, Integer>
		implements LeadMembershipHospitalizationDao {

	private static final Logger LOG = LoggerFactory.getLogger(LeadMembershipHospitalizationDaoImpl.class);
	...
	public LeadMembershipHospitalization deleteById(final Integer id) {
		LeadMembershipHospitalization entity = super.get(id);
		if (entity != null) {
	 ...
	 */
	@Override
	protected Class<LeadMembershipHospitalization> getEntityClass() {
		return LeadMembershipHospitalization.class;
	}

	/*
	 * (non-Javadoc)
	 * 
	 * @see com.pfchoice.core.dao.LeadMembershipHospitalizationDao#loadData()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.pfchoice.core.dao.LeadMembershipHospitalizationDao#unloadCSV2Table()
	 */
	@Override
