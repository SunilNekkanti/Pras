 ...
 */
@Repository
public class LeadMembershipHedisMeasureDaoImpl extends HibernateBaseDao<LeadMembershipHedisMeasure, Integer>
		implements LeadMembershipHedisMeasureDao {

	/*
	 * (non-Javadoc)
	 * 
	 * @see com.pfchoice.core.dao.LeadMembershipHedisMeasureDao#getPage(int, int,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.pfchoice.core.dao.LeadMembershipHedisMeasureDao#findById(java.lang.
	 * Integer)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.pfchoice.core.dao.LeadMembershipHedisMeasureDao#save(com.pfchoice.core.
	 * entity.LeadMembershipHedisMeasure)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.pfchoice.core.dao.LeadMembershipHedisMeasureDao#deleteById(java.lang.
	 * Integer)
	 */
	@Override
	public LeadMembershipHedisMeasure deleteById(final Integer id) {
		LeadMembershipHedisMeasure entity = super.get(id);
		if (entity != null) {
	...
	@Override
	protected Class<LeadMembershipHedisMeasure> getEntityClass() {
		return LeadMembershipHedisMeasure.class;
	}
	 ...
	 * 
	 * @see
	 * com.pfchoice.core.dao.LeadMembershipHedisMeasureDao#findByMbrIdAndRuleId(java
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.pfchoice.core.dao.LeadMembershipHedisMeasureDao#loadData(java.lang.
	 * Integer)
	 */
	@Override
	public Integer loadData(final Integer fileId, final Integer insId, final Integer leadMbrId, final String insuranceCode,final Integer reportMonth) {
		...
		return getSession().createSQLQuery(loadDataQuery).setInteger("fileId", fileId).setInteger("insId", insId).setInteger("reportMonth", reportMonth)
				.setInteger("leadMbrId", leadMbrId)
				.executeUpdate();
	}
	
	/* (non-Javadoc)
	 * @see com.pfchoice.core.dao.LeadMembershipHedisMeasureDao#unloadTable()
	 */
	@Override
