 ...
 */
@Repository
public class MembershipHedisMeasureDaoImpl extends HibernateBaseDao<MembershipHedisMeasure, Integer> implements MembershipHedisMeasureDao
{

    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(MembershipHedisMeasureDaoImpl.class
        .getName());
