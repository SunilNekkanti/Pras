...
public class MembershipHedisMeasureServiceImpl implements MembershipHedisMeasureService {
	...
	/* (non-Javadoc)
	 * @see com.pfchoice.core.service.MembershipHedisMeasureService#deleteById(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.pfchoice.core.service.MembershipHedisMeasureService#findById(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.pfchoice.core.service.MembershipHedisMeasureService#getPage(int, int, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	@Transactional(readOnly = true)
	...
	/* (non-Javadoc)
	 * @see com.pfchoice.core.service.MembershipHedisMeasureService#getPage(int, int, java.lang.String, int, int, int, java.lang.String, java.lang.String)
	 */
	@Override
	@Transactional(readOnly = true)
	...
	/* (non-Javadoc)
	 * @see com.pfchoice.core.service.MembershipHedisMeasureService#save(com.pfchoice.core.entity.MembershipHedisMeasure)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.pfchoice.core.service.MembershipHedisMeasureService#update(com.pfchoice.core.entity.MembershipHedisMeasure)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.pfchoice.core.service.MembershipHedisMeasureService#findByMbrIdAndRuleId(java.lang.Integer, java.lang.Integer)
	 */
	@Override
